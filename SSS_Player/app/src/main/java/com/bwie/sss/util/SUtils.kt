 ...
 * 1.类的用途
 * 2.@authorDell
 * 3.@date2017/11/29 10:06
 */
class SUtils private constructor(context: Context, spName: String) {
    ...
    companion object {
        ...
        private val sSPMap = HashMap<String,SUtils>()
         ...
         * @return [SPUtils]
         */
        fun getInstance(context: Context, spName: String): SUtils {
            var spName = spName
            if (isSpace(spName)) spName = "spUtils"
            var sp: SUtils? = sSPMap[spName]
            if (sp == null) {
                sp = SUtils(context,spName)
