 ...
 */
data class VideoB(var feed:String?, var title:String?, var description:String?,
    ...
    companion object {
        @JvmField val CREATOR: Parcelable.Creator<VideoB> = object : Parcelable.Creator<VideoB> {
            override fun createFromParcel(source: Parcel): VideoB = VideoB(source)
            override fun newArray(size: Int): Array<VideoB?> = arrayOfNulls(size)
        }
    }
